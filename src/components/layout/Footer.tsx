  ...
  return (
    <footer className="bg-surface-dark text-background py-16 mt-auto">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <h3 className="font-heading text-xl font-medium mb-4 text-primary">Contacto</h3>
          <ul className="space-y-3">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-16 pt-8 border-t border-background/10 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-xs text-background/60">
          © {new Date().getFullYear()} Espacio Reiki con Carmen Rocío. Todos los derechos reservados.
        </p>
